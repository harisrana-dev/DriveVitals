...
export function mapTrip(t) {
  ...
  return {
    ...
    currentSpeed: t.current_speed_kmh ?? null,
    speeding: t.speeding ?? false,
    harshBraking: t.harsh_braking ?? false,
    aggressiveThrottle: t.aggressive_throttle ?? false,
    highRpm: t.high_rpm ?? false,
